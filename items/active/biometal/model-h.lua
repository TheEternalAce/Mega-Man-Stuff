...
function activate(fireMode, shiftHeld)
    ...
    if fireMode == "primary" then
        ...
        local objectName = "sonicblade"
		local objectName1 = "sonicblade"
		local objectName2 = "reploid-tier5head-model-h"
		local objectName3 = "reploid-tier5chest-model-h"
		local objectName4 = "reploid-tier5pants-model-h"
